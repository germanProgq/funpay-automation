...
static const char fpv_db_migration_3_sql[] =
    "CREATE TABLE IF NOT EXISTS fpv_funpay_sessions ("
    "  golden_key TEXT PRIMARY KEY,"
    "  phpsessid TEXT,"
    "  updated_at_ms BIGINT NOT NULL"
    ");"
    "CREATE INDEX IF NOT EXISTS fpv_funpay_sessions_updated_idx"
    "  ON fpv_funpay_sessions(updated_at_ms);"
    "CREATE TABLE IF NOT EXISTS fpv_tg_sessions ("
    "  tg_user_id BIGINT PRIMARY KEY,"
    "  user_id TEXT NOT NULL,"
    "  updated_at_ms BIGINT NOT NULL"
    ");"
    "CREATE INDEX IF NOT EXISTS fpv_tg_sessions_updated_idx"
    "  ON fpv_tg_sessions(updated_at_ms);";

static const char fpv_db_migration_4_sql[] =
    "ALTER TABLE fpv_organizations ADD COLUMN price_change_approval_required "
    "BOOLEAN NOT NULL DEFAULT 0;"
    "CREATE TABLE IF NOT EXISTS fpv_team_category_scopes ("
    "  team_id TEXT NOT NULL REFERENCES fpv_teams(id) ON DELETE CASCADE,"
    "  category TEXT NOT NULL,"
    "  subcategory TEXT NOT NULL,"
    "  PRIMARY KEY (team_id, category, subcategory)"
    ");"
    "CREATE INDEX IF NOT EXISTS fpv_team_category_scopes_team_idx"
    "  ON fpv_team_category_scopes(team_id);"
    "CREATE INDEX IF NOT EXISTS fpv_team_category_scopes_category_idx"
    "  ON fpv_team_category_scopes(category);"
    "CREATE TABLE IF NOT EXISTS fpv_team_price_scopes ("
    "  team_id TEXT NOT NULL REFERENCES fpv_teams(id) ON DELETE CASCADE,"
    "  scope INTEGER NOT NULL,"
    "  PRIMARY KEY (team_id, scope)"
    ");"
    "CREATE INDEX IF NOT EXISTS fpv_team_price_scopes_team_idx"
    "  ON fpv_team_price_scopes(team_id);"
    "CREATE TABLE IF NOT EXISTS fpv_team_alert_scopes ("
    "  team_id TEXT NOT NULL REFERENCES fpv_teams(id) ON DELETE CASCADE,"
    "  alert_type TEXT NOT NULL,"
    "  PRIMARY KEY (team_id, alert_type)"
    ");"
    "CREATE INDEX IF NOT EXISTS fpv_team_alert_scopes_team_idx"
    "  ON fpv_team_alert_scopes(team_id);"
    "CREATE TABLE IF NOT EXISTS fpv_access_reviews ("
    "  id TEXT PRIMARY KEY,"
    "  organization_id TEXT NOT NULL REFERENCES fpv_organizations(id)"
    "    ON DELETE CASCADE,"
    "  reviewer_user_id TEXT REFERENCES fpv_users(id) ON DELETE SET NULL,"
    "  note TEXT,"
    "  reviewed_at_ms BIGINT NOT NULL"
    ");"
    "CREATE INDEX IF NOT EXISTS fpv_access_reviews_org_idx"
    "  ON fpv_access_reviews(organization_id, reviewed_at_ms);"
    "CREATE TABLE IF NOT EXISTS fpv_price_change_requests ("
    "  id TEXT PRIMARY KEY,"
    "  organization_id TEXT NOT NULL REFERENCES fpv_organizations(id)"
    "    ON DELETE CASCADE,"
    "  team_id TEXT REFERENCES fpv_teams(id) ON DELETE SET NULL,"
    "  listing_id TEXT NOT NULL REFERENCES fpv_listings(id)"
    "    ON DELETE CASCADE,"
    "  price_rule_id TEXT REFERENCES fpv_price_rules(id) ON DELETE SET NULL,"
    "  requested_by_user_id TEXT REFERENCES fpv_users(id) ON DELETE SET NULL,"
    "  current_price REAL NOT NULL,"
    "  requested_price REAL NOT NULL,"
    "  currency TEXT NOT NULL,"
    "  reason TEXT,"
    "  status INTEGER NOT NULL,"
    "  reviewed_by_user_id TEXT REFERENCES fpv_users(id) ON DELETE SET NULL,"
    "  review_note TEXT,"
    "  requested_at_ms BIGINT NOT NULL,"
    "  reviewed_at_ms BIGINT NOT NULL,"
    "  applied_at_ms BIGINT NOT NULL"
    ");"
    "CREATE INDEX IF NOT EXISTS fpv_price_change_requests_org_idx"
    "  ON fpv_price_change_requests(organization_id, status, requested_at_ms);"
    "CREATE INDEX IF NOT EXISTS fpv_price_change_requests_listing_idx"
    "  ON fpv_price_change_requests(listing_id);";

static const char fpv_db_migration_5_sql[] =
    "ALTER TABLE fpv_organizations ADD COLUMN tier INTEGER NOT NULL DEFAULT 1;";

static const char fpv_db_migration_6_sql[] =
    "CREATE TABLE IF NOT EXISTS fpv_valorant_api_fetches ("
    "  id TEXT PRIMARY KEY,"
    "  user_id TEXT NOT NULL,"
    ...
    ");"
    "CREATE INDEX IF NOT EXISTS fpv_valorant_api_fetches_user_idx"
    "  ON fpv_valorant_api_fetches(user_id, fetched_at_ms);"
    "CREATE INDEX IF NOT EXISTS fpv_valorant_api_fetches_endpoint_idx"
    "  ON fpv_valorant_api_fetches(endpoint_key);";
...
static const fpv_db_migration_t fpv_db_migrations[] = {
    ...
    {3, "session_cache", fpv_db_migration_3_sql},
    {4, "team_admin_controls", fpv_db_migration_4_sql},
    {5, "product_tiers", fpv_db_migration_5_sql},
    {6, "valorant_api_fetches", fpv_db_migration_6_sql},
};
